...
"use strict";
eval("\nObject.defineProperty(exports, \"__esModule\", { value: true });\nexports.canvas = document.getElementById('canvas');\nexports.canvasWidth = exports.canvas.width;\nexports.canvasHeight = exports.canvas.height;\nexports.NUMBER = {\n    ROW: 10,\n    COLUMN: 16,\n    a: 4,\n    DOWN_KEY: 40,\n    HARD_DOWN_KEY: 90,\n    UP_KEY: 38,\n    LEFT_KEY: 37,\n    RIGHT_KEY: 39,\n    ENTER_KEY: 13,\n    LEFT_MOVE: -1,\n    RIGHT_MOVE: 1,\n    DEGREES: 90,\n    QUEUE_ROW: 6,\n    QUEUE_COLUMN: 8,\n};\nexports.STRING = {\n    EMPTY: 'empty',\n    CURRENT: 'current',\n    LEFT: 'left',\n    RIGHT: 'right',\n    DOWN: 'down'\n};\nexports.rgba = [\n    [240, 241, 77, 1.0],\n    [105, 241, 240, 1.0],\n    [27, 68, 241, 1.0],\n    [240, 161, 63, 1.0],\n    [163, 77, 240, 1.0],\n    [114, 242, 63, 1.0],\n    [237, 56, 51, 1.0]\n];\nexports.Prop = {\n    BLOCKS: [\n        // O-block\n        {\n            number: [\n                exports.NUMBER.a,\n                exports.NUMBER.a + 1,\n                exports.NUMBER.a + exports.NUMBER.ROW,\n                exports.NUMBER.a + exports.NUMBER.ROW + 1\n            ],\n            color: `rgba(${exports.rgba[0]})`,\n        },\n        // I-block\n        {\n            number: [\n                exports.NUMBER.a,\n                exports.NUMBER.a + exports.NUMBER.ROW,\n                exports.NUMBER.a + (exports.NUMBER.ROW * 2),\n                exports.NUMBER.a + (exports.NUMBER.ROW * 3)\n            ],\n            color: `rgba(${exports.rgba[1]})`,\n        },\n        // J-block\n        {\n            number: [\n                exports.NUMBER.a,\n                exports.NUMBER.a + 1,\n                exports.NUMBER.a + exports.NUMBER.ROW,\n                exports.NUMBER.a + (exports.NUMBER.ROW * 2)\n            ],\n            color: `rgba(${exports.rgba[2]})`,\n        },\n        // L-block\n        {\n            number: [\n                exports.NUMBER.a,\n                exports.NUMBER.a + 1,\n                exports.NUMBER.a + exports.NUMBER.ROW + 1,\n                exports.NUMBER.a + (exports.NUMBER.ROW * 2) + 1\n            ],\n            color: `rgba(${exports.rgba[3]})`,\n        },\n        // T-block\n        {\n            number: [\n                exports.NUMBER.a,\n                exports.NUMBER.a + exports.NUMBER.ROW,\n                exports.NUMBER.a + exports.NUMBER.ROW + 1,\n                exports.NUMBER.a + (exports.NUMBER.ROW * 2)\n            ],\n            color: `rgba(${exports.rgba[4]})`,\n        },\n        // S-block\n        {\n            number: [\n                exports.NUMBER.a,\n                exports.NUMBER.a + exports.NUMBER.ROW,\n                exports.NUMBER.a + exports.NUMBER.ROW + 1,\n                exports.NUMBER.a + (exports.NUMBER.ROW * 2) + 1\n            ],\n            color: `rgba(${exports.rgba[5]})`,\n        },\n        // Z-block\n        {\n            number: [\n                exports.NUMBER.a + 1,\n                exports.NUMBER.a + exports.NUMBER.ROW,\n                exports.NUMBER.a + exports.NUMBER.ROW + 1,\n                exports.NUMBER.a + (exports.NUMBER.ROW * 2)\n            ],\n            color: `rgba(${exports.rgba[6]})`\n        },\n    ]\n};\n\n\n//# sourceURL=webpack:///./src/data.ts?");
...
"use strict";
eval("\nvar __importStar = (this && this.__importStar) || function (mod) {\n    if (mod && mod.__esModule) return mod;\n    var result = {};\n    if (mod != null) for (var k in mod) if (Object.hasOwnProperty.call(mod, k)) result[k] = mod[k];\n    result[\"default\"] = mod;\n    return result;\n};\nObject.defineProperty(exports, \"__esModule\", { value: true });\nconst Data = __importStar(__webpack_require__(/*! ./data */ \"./src/data.ts\"));\nconst Fn = __importStar(__webpack_require__(/*! ./function */ \"./src/function.ts\"));\nconst State = __importStar(__webpack_require__(/*! ./state */ \"./src/state.ts\"));\nconst Action = __importStar(__webpack_require__(/*! ./event */ \"./src/event.ts\"));\nconst Debug = __importStar(__webpack_require__(/*! ./dev */ \"./src/dev.ts\"));\nconst clonedeep = __webpack_require__(/*! lodash/cloneDeep */ \"./node_modules/lodash/cloneDeep.js\");\nexports.ctx = Data.canvas.getContext('2d');\n// use anti-aliasing or not\nif (Debug.Settings.antiAliasing) {\n    exports.ctx.translate(0.5, 0.5);\n}\n// check device screen size\nexports.ScreenSize = {\n    getWidth: window.parent.screen.width,\n    getHeight: window.parent.screen.height,\n};\n// resize canvas size\nfunction resizeCanvasArea() {\n    if (exports.ScreenSize.getWidth > 400) {\n        Data.canvas.width = 400;\n        Data.canvas.height = 600;\n    }\n    if (exports.ScreenSize.getHeight < 600) {\n        Data.canvas.height = Math.floor(exports.ScreenSize.getHeight * 0.9);\n    }\n    if (exports.ScreenSize.getWidth < 420 && exports.ScreenSize.getWidth > 320) {\n        Data.canvas.width = exports.ScreenSize.getWidth;\n        Data.canvas.height = 600;\n        exports.GRID_SIZE.HORIZON = Math.floor(exports.GRID_SIZE.HORIZON * 0.9);\n        exports.GRID_SIZE.STEP = exports.GRID_SIZE.HORIZON / 10;\n        exports.GRID_SIZE.getVertical();\n        exports.GRID_SIZE.QUEUE_STEP = exports.GRID_SIZE.STEP - exports.GRID_SIZE.STANDARD;\n    }\n    if (exports.ScreenSize.getWidth < 321) {\n        Data.canvas.width = exports.ScreenSize.getWidth;\n        exports.GRID_SIZE.HORIZON = Math.floor(exports.GRID_SIZE.HORIZON * 0.85);\n        exports.GRID_SIZE.STEP = exports.GRID_SIZE.HORIZON / 10;\n        exports.GRID_SIZE.getVertical();\n        exports.GRID_SIZE.QUEUE_STEP = exports.GRID_SIZE.STEP - exports.GRID_SIZE.STANDARD;\n    }\n}\nexports.resizeCanvasArea = resizeCanvasArea;\nconst QueueProp = clonedeep(Data.Prop);\nexports.GRID_SIZE = {\n    HORIZON: 270,\n    VERTICAL: 378,\n    STANDARD: 7,\n    STEP: 27,\n    QUEUE_STEP: 20,\n    getVertical: function () {\n        this.VERTICAL = this.STEP * Data.NUMBER.COLUMN;\n    },\n};\nexports.GRID_SIZE.getVertical();\nconst TEXT = {\n    FONT: 'Osaka',\n    FONTSIZE: '16px ',\n    FONTSIZE2: '18px ',\n    NEXT: 'Next',\n    LINE: 'Line',\n    LEVEL: 'Level',\n    PLAY: 'Play ?',\n    GAMEOVER: 'Game Over',\n    REPLAY: 'Replay ?',\n};\nfunction clearAll() {\n    exports.ctx.clearRect(0, 0, Data.canvas.width, Data.canvas.height);\n}\nexports.clearAll = clearAll;\nfunction clearField() {\n    exports.ctx.clearRect(exports.GRID_SIZE.STANDARD - 7, exports.GRID_SIZE.STANDARD - 7, exports.GRID_SIZE.HORIZON + 10, exports.GRID_SIZE.VERTICAL + 10);\n}\nexports.clearField = clearField;\nfunction clearQueue() {\n    exports.ctx.clearRect(exports.GRID_SIZE.HORIZON + 7, 0, Data.canvas.width, Data.canvas.height);\n}\nexports.clearQueue = clearQueue;\nfunction clearButton() {\n    exports.ctx.clearRect(0, exports.GRID_SIZE.VERTICAL + 10, Data.canvas.width, Data.canvas.height);\n}\nexports.clearButton = clearButton;\nfunction fillBackGround() {\n    // background\n    exports.ctx.fillStyle = 'rgb(0,0,0)';\n    exports.ctx.fillRect(0, 0, Data.canvas.width, Data.canvas.height);\n    exports.ctx.fill();\n}\nexports.Division = {\n    start: function (callback) {\n        fillBackGround();\n        exports.ctx.font = `${TEXT.FONTSIZE2 + TEXT.FONT}`;\n        exports.ctx.fillStyle = 'rgba(255,255,255,0.9)';\n        const playWdith = Math.floor(exports.ctx.measureText(TEXT.PLAY).width);\n        exports.ctx.fillText(TEXT.PLAY, (Data.canvas.width - playWdith) / 2, Data.canvas.height / 2);\n        // replay button\n        const play = (e) => {\n            const button = Object.create(Action.onCanvas);\n            button.point(e);\n            button.figure = 'square';\n            button.square.x = (Data.canvas.width - playWdith) / 2;\n            button.square.y = (Data.canvas.height / 2) - 20;\n            button.square.w = playWdith;\n            button.square.h = 40;\n            if (button.hit()) {\n                Data.canvas.removeEventListener('click', play, false);\n                window.removeEventListener('keydown', keyDown, false);\n                callback();\n            }\n        };\n        Data.canvas.addEventListener('click', play, false);\n        // if enter key pressed\n        const keyDown = (event) => {\n            if (Action.UserEvent.confirm(event)) {\n                Data.canvas.removeEventListener('click', play, false);\n                window.removeEventListener('keydown', keyDown, false);\n                callback();\n            }\n        };\n        window.addEventListener('keydown', keyDown, false);\n    },\n    gameOver: function (callback) {\n        // text\n        exports.ctx.fillStyle = 'rgba(255,255,255,0.9)';\n        exports.ctx.fillRect(0, 0, Data.canvas.width, Data.canvas.height);\n        exports.ctx.fill();\n        exports.ctx.font = `${TEXT.FONTSIZE2 + TEXT.FONT}`;\n        exports.ctx.fillStyle = 'rgba(51,51,51,1.0)';\n        const gameWdith = Math.floor(exports.ctx.measureText(TEXT.GAMEOVER).width);\n        const replayWdith = Math.floor(exports.ctx.measureText(TEXT.REPLAY).width);\n        exports.ctx.fillText(TEXT.GAMEOVER, (Data.canvas.width - gameWdith) / 2, Data.canvas.height / 2);\n        exports.ctx.fillText(TEXT.REPLAY, (Data.canvas.width - replayWdith) / 2, (Data.canvas.height / 2) + 40);\n        // replay button\n        const replay = (e) => {\n            const button = Object.create(Action.onCanvas);\n            button.point(e);\n            button.figure = 'square';\n            button.square.x = (Data.canvas.width - replayWdith) / 2;\n            button.square.y = (Data.canvas.height / 2);\n            button.square.w = replayWdith;\n            button.square.h = 40;\n            if (button.hit()) {\n                Data.canvas.removeEventListener('click', replay, false);\n                window.removeEventListener('keydown', keyDown, false);\n                callback();\n            }\n        };\n        Data.canvas.addEventListener('click', replay, false);\n        // if enter key pressed\n        const keyDown = (event) => {\n            if (Action.UserEvent.confirm(event)) {\n                Data.canvas.removeEventListener('click', replay, false);\n                window.removeEventListener('keydown', keyDown, false);\n                callback();\n            }\n        };\n        window.addEventListener('keydown', keyDown, false);\n    }\n};\nexports.TouchAction = {\n    _HORIZON: ((exports.GRID_SIZE.HORIZON + (exports.GRID_SIZE.STANDARD * 2)) / 2),\n    MARGIN_BOTTOM: 60,\n    _LENGTH: 15,\n    _RADIANS: 5,\n    // left button\n    left: function () {\n        const HORIZON = this._HORIZON - (this._HORIZON / 1.4);\n        const CENTER = exports.GRID_SIZE.VERTICAL + this.MARGIN_BOTTOM;\n        const LENGTH = this._LENGTH;\n        const RADIANS = this._LENGTH + this._RADIANS;\n        // triangle\n        const triangle = new Path2D();\n        exports.ctx.beginPath();\n        triangle.moveTo(HORIZON + (LENGTH / 2), CENTER - (LENGTH / 3));\n        triangle.lineTo(HORIZON, CENTER);\n        triangle.lineTo(HORIZON + (LENGTH / 2), CENTER + (LENGTH / 3));\n        // line\n        const line = new Path2D();\n        exports.ctx.beginPath();\n        line.moveTo(HORIZON, CENTER);\n        line.lineTo(HORIZON + (LENGTH + 5), CENTER);\n        // circle\n        const circle = new Path2D();\n        exports.ctx.beginPath();\n        circle.arc(HORIZON + 10, CENTER, RADIANS, 0, 2 * Math.PI);\n        function render() {\n            exports.ctx.stroke(triangle);\n            exports.ctx.stroke(line);\n            exports.ctx.stroke(circle);\n        }\n        return {\n            render,\n            rect: [(HORIZON + LENGTH) - this._RADIANS, CENTER, RADIANS]\n        };\n    },\n    // right button\n    right: function () {\n        const HORIZON = this._HORIZON + (this._HORIZON / 1.4) - this._LENGTH;\n        const CENTER = exports.GRID_SIZE.VERTICAL + this.MARGIN_BOTTOM;\n        const LENGTH = this._LENGTH;\n        const RADIANS = this._LENGTH + this._RADIANS;\n        // triangle\n        const triangle = new Path2D();\n        exports.ctx.beginPath();\n        triangle.moveTo(HORIZON + LENGTH, CENTER - (LENGTH / 3));\n        triangle.lineTo(HORIZON + (LENGTH / 0.7), CENTER);\n        triangle.lineTo(HORIZON + LENGTH, CENTER + (LENGTH / 3));\n        // line\n        const line = new Path2D();\n        exports.ctx.beginPath();\n        line.moveTo(HORIZON, CENTER);\n        line.lineTo(HORIZON + (LENGTH + 5), CENTER);\n        // circle\n        const circle = new Path2D();\n        exports.ctx.beginPath();\n        circle.arc(HORIZON + 10, CENTER, RADIANS, 0, 2 * Math.PI);\n        function render() {\n            exports.ctx.stroke(triangle);\n            exports.ctx.stroke(line);\n            exports.ctx.stroke(circle);\n        }\n        return {\n            render,\n            rect: [(HORIZON + LENGTH) - this._RADIANS, CENTER, RADIANS]\n        };\n    },\n    // down button\n    down: function () {\n        const HORIZON = this._HORIZON - (this._HORIZON / 2.5);\n        const CENTER = exports.GRID_SIZE.VERTICAL + this.MARGIN_BOTTOM + (this._LENGTH * 3);\n        const LENGTH = this._LENGTH;\n        const RADIANS = this._LENGTH + this._RADIANS;\n        // triangle\n        const triangle = new Path2D();\n        exports.ctx.beginPath();\n        triangle.moveTo(HORIZON + (LENGTH / 2.7), CENTER + (LENGTH / 5));\n        triangle.lineTo(HORIZON + (LENGTH / 1.5), CENTER + (LENGTH / 1.8));\n        triangle.lineTo(HORIZON + (LENGTH / 1), CENTER + (LENGTH / 5));\n        // line\n        const line = new Path2D();\n        exports.ctx.beginPath();\n        line.moveTo(HORIZON + (LENGTH / 1.5), CENTER - (LENGTH / 1.8));\n        line.lineTo(HORIZON + (LENGTH / 1.5), CENTER + (LENGTH / 1.8));\n        // circle\n        const circle = new Path2D();\n        exports.ctx.beginPath();\n        circle.arc(HORIZON + 10, CENTER, RADIANS, 0, 2 * Math.PI);\n        function render() {\n            exports.ctx.stroke(triangle);\n            exports.ctx.stroke(line);\n            exports.ctx.stroke(circle);\n        }\n        return {\n            render,\n            rect: [(HORIZON + LENGTH) - this._RADIANS, CENTER, RADIANS]\n        };\n    },\n    // down button\n    hardDown: function () {\n        const HORIZON = this._HORIZON;\n        const CENTER = exports.GRID_SIZE.VERTICAL + this.MARGIN_BOTTOM + (this._LENGTH * 3);\n        const LENGTH = this._LENGTH;\n        const RADIANS = this._LENGTH + this._RADIANS;\n        // triangle\n        const triangle = new Path2D();\n        exports.ctx.beginPath();\n        triangle.moveTo(HORIZON + (LENGTH / 2.7), CENTER + (LENGTH / 5));\n        triangle.lineTo(HORIZON + (LENGTH / 1.5), CENTER + (LENGTH / 1.8));\n        triangle.lineTo(HORIZON + (LENGTH / 1), CENTER + (LENGTH / 5));\n        // triangle2\n        const triangle2 = new Path2D();\n        exports.ctx.beginPath();\n        triangle2.moveTo(HORIZON + (LENGTH / 2.7), CENTER + (LENGTH / 9));\n        triangle2.lineTo(HORIZON + (LENGTH / 1.5), CENTER + (LENGTH / 5.8));\n        triangle2.lineTo(HORIZON + (LENGTH / 1), CENTER + (LENGTH / 9));\n        // circle\n        const circle = new Path2D();\n        exports.ctx.beginPath();\n        circle.arc(HORIZON + 10, CENTER, RADIANS, 0, 2 * Math.PI);\n        function render() {\n            exports.ctx.stroke(triangle);\n            exports.ctx.stroke(triangle2);\n            exports.ctx.stroke(circle);\n        }\n        return {\n            render,\n            rect: [(HORIZON + LENGTH) - this._RADIANS, CENTER, RADIANS]\n        };\n    },\n    // rotate button\n    rotate: function () {\n        const HORIZON = this._HORIZON + (this._HORIZON / 2.5);\n        const CENTER = exports.GRID_SIZE.VERTICAL + this.MARGIN_BOTTOM + (this._LENGTH * 3);\n        const LENGTH = this._LENGTH;\n        const RADIANS = this._LENGTH + this._RADIANS;\n        // triangle\n        const triangle = new Path2D();\n        exports.ctx.beginPath();\n        triangle.moveTo(HORIZON + (LENGTH / 1.2), CENTER - (LENGTH / 3));\n        triangle.lineTo(HORIZON + (LENGTH / 0.8), CENTER);\n        triangle.lineTo(HORIZON + (LENGTH / 0.6), CENTER - (LENGTH / 3));\n        // circleLine\n        const circleLine = new Path2D();\n        exports.ctx.beginPath();\n        circleLine.arc(HORIZON + 10, CENTER, RADIANS / 2, 0, 180);\n        // circle\n        const circle = new Path2D();\n        exports.ctx.beginPath();\n        circle.arc(HORIZON + 10, CENTER, RADIANS, 0, 2 * Math.PI);\n        function render() {\n            exports.ctx.stroke(triangle);\n            exports.ctx.stroke(circleLine);\n            exports.ctx.stroke(circle);\n        }\n        return {\n            render,\n            rect: [(HORIZON + LENGTH) - this._RADIANS, CENTER, RADIANS]\n        };\n    },\n};\nfunction renderField() {\n    // background\n    fillBackGround();\n    // line settings\n    exports.ctx.lineWidth = 1;\n    exports.ctx.strokeStyle = 'rgba(255,255,255,0.6)';\n    exports.ctx.fillStyle = 'rgba(255,255,255,0.7)';\n    // outline\n    const outline = new Path2D();\n    exports.ctx.beginPath();\n    outline.rect(exports.GRID_SIZE.STANDARD, exports.GRID_SIZE.STANDARD, exports.GRID_SIZE.HORIZON, exports.GRID_SIZE.VERTICAL);\n    exports.ctx.stroke(outline);\n    // grid\n    const grid = new Path2D();\n    // horizon line\n    for (let i = exports.GRID_SIZE.STEP + exports.GRID_SIZE.STANDARD; i < exports.GRID_SIZE.VERTICAL; i += exports.GRID_SIZE.STEP) {\n        exports.ctx.beginPath();\n        grid.moveTo(exports.GRID_SIZE.STANDARD, i);\n        grid.lineTo(exports.GRID_SIZE.HORIZON + exports.GRID_SIZE.STANDARD, i);\n    }\n    // vertical line\n    for (let i = exports.GRID_SIZE.STEP + exports.GRID_SIZE.STANDARD; i < exports.GRID_SIZE.HORIZON; i += exports.GRID_SIZE.STEP) {\n        exports.ctx.beginPath();\n        grid.moveTo(i, exports.GRID_SIZE.STANDARD);\n        grid.lineTo(i, exports.GRID_SIZE.VERTICAL + exports.GRID_SIZE.STANDARD);\n    }\n    exports.ctx.stroke(grid);\n    // touch button\n    exports.TouchAction.left().render();\n    exports.TouchAction.right().render();\n    exports.TouchAction.down().render();\n    exports.TouchAction.hardDown().render();\n    exports.TouchAction.rotate().render();\n    // HUD\n    exports.ctx.font = `${TEXT.FONTSIZE + TEXT.FONT}`;\n    const nextWdith = Math.floor(exports.ctx.measureText(TEXT.NEXT).width);\n    const levelWdith = Math.floor(exports.ctx.measureText(TEXT.LEVEL).width);\n    const lineWdith = Math.floor(exports.ctx.measureText(TEXT.LINE).width);\n    const levelNumberWidth = Math.floor(exports.ctx.measureText(State.Info.level.toString()).width);\n    const lineNumberWidth = Math.floor(exports.ctx.measureText(State.Info.completedRow.toString()).width);\n    exports.ctx.fillText(TEXT.NEXT, (exports.GRID_SIZE.HORIZON + Data.canvas.width - (nextWdith / 2)) / 2, exports.GRID_SIZE.STEP);\n    exports.ctx.fillText(TEXT.LEVEL, (exports.GRID_SIZE.HORIZON + Data.canvas.width - (levelWdith / 2)) / 2, (exports.GRID_SIZE.VERTICAL - (exports.GRID_SIZE.QUEUE_STEP * 7)));\n    exports.ctx.fillText(State.Info.level.toString(), (exports.GRID_SIZE.HORIZON + Data.canvas.width - (levelNumberWidth / 2)) / 2, (exports.GRID_SIZE.VERTICAL - (exports.GRID_SIZE.QUEUE_STEP * 5)));\n    exports.ctx.fillText(TEXT.LINE, (exports.GRID_SIZE.HORIZON + Data.canvas.width - (lineWdith / 2)) / 2, (exports.GRID_SIZE.VERTICAL - (exports.GRID_SIZE.QUEUE_STEP * 3)));\n    exports.ctx.fillText(State.Info.completedRow.toString(), (exports.GRID_SIZE.HORIZON + Data.canvas.width - (lineNumberWidth / 2)) / 2, (exports.GRID_SIZE.VERTICAL - (exports.GRID_SIZE.QUEUE_STEP * 1)));\n    if (Debug.Settings.console) {\n        exports.ctx.fillText('bottom', Data.canvas.width / 2, exports.GRID_SIZE.VERTICAL);\n    }\n}\nexports.renderField = renderField;\nfunction clearBlock(fieldArray) {\n    fieldArray.forEach((v, i) => {\n        if (v === Data.STRING.EMPTY) {\n            return;\n        }\n        // draw controllable block\n        if (v === Data.STRING.CURRENT) {\n            exports.ctx.clearRect((Fn.fixToFirstDigit(i) * exports.GRID_SIZE.STEP) + (exports.GRID_SIZE.STANDARD + 1), (Math.floor(i / Data.NUMBER.ROW) * exports.GRID_SIZE.STEP) + (exports.GRID_SIZE.STANDARD + 1), exports.GRID_SIZE.STEP - 2, exports.GRID_SIZE.STEP - 2);\n        }\n    });\n}\nexports.clearBlock = clearBlock;\nfunction renderBlock(fieldArray) {\n    fieldArray.forEach((v, i) => {\n        if (v === Data.STRING.EMPTY) {\n            return;\n        }\n        // draw controllable block\n        if (v === Data.STRING.CURRENT) {\n            exports.ctx.fillStyle = State.Block.deepCopy.BLOCKS[State.Block.blockNumber].color;\n            exports.ctx.fillRect((Fn.fixToFirstDigit(i) * exports.GRID_SIZE.STEP) + (exports.GRID_SIZE.STANDARD + 1), (Math.floor(i / Data.NUMBER.ROW) * exports.GRID_SIZE.STEP) + (exports.GRID_SIZE.STANDARD + 1), exports.GRID_SIZE.STEP - 2, exports.GRID_SIZE.STEP - 2);\n            exports.ctx.fill();\n        }\n        // draw fixed block\n        if (v !== Data.STRING.CURRENT && typeof v === 'number') {\n            exports.ctx.fillStyle = State.Block.deepCopy.BLOCKS[v].color;\n            exports.ctx.fillRect((Fn.fixToFirstDigit(i) * exports.GRID_SIZE.STEP) + (exports.GRID_SIZE.STANDARD + 1), (Math.floor(i / Data.NUMBER.ROW) * exports.GRID_SIZE.STEP) + (exports.GRID_SIZE.STANDARD + 1), exports.GRID_SIZE.STEP - 2, exports.GRID_SIZE.STEP - 2);\n            exports.ctx.fill();\n        }\n    });\n}\nexports.renderBlock = renderBlock;\nfunction renderQueue(queue) {\n    // only one block to pick\n    //const num = State.blockQueue.queue[1];\n    //const block = State.rotatedBlock(QueueProp.BLOCKS[num].number, angle, false, num);\n    //block.forEach(v => queue[v] = num);\n    // pick block number form block queue\n    const nums = State.blockQueue.queue.slice(1, 4);\n    nums.forEach((v, i) => {\n        let angle = 0;\n        let start = 0;\n        let temp = State.rotatedBlock(QueueProp.BLOCKS[v].number, angle, false, v);\n        // fix positions\n        if (v === 0) {\n            angle = 0;\n        }\n        if (v !== 0) {\n            angle = Data.NUMBER.DEGREES;\n        }\n        if (v === 1) {\n            temp.forEach((_, i, arr) => { arr[i] -= (Data.NUMBER.ROW - 1); });\n        }\n        if (v === 2) {\n            angle = Data.NUMBER.DEGREES * 3;\n            temp.forEach((_, i, arr) => { arr[i] -= Data.NUMBER.ROW; });\n        }\n        if (v === 3) {\n            temp.forEach((_, i, arr) => { arr[i] += (Data.NUMBER.ROW + 1); });\n        }\n        if (v === 4) {\n            temp.forEach((_, i, arr) => { arr[i] += (Data.NUMBER.ROW + 1); });\n            temp[3] -= Data.NUMBER.ROW * 2;\n        }\n        if (v === 5) {\n            temp.forEach((_, i, arr) => { arr[i] -= (Data.NUMBER.ROW + 1); });\n        }\n        if (v === 6) {\n            temp.forEach((_, i, arr) => { arr[i] -= 1; });\n        }\n        if (i === 0) {\n            temp.forEach(w => queue[w] = v);\n        }\n        if (i === 1) {\n            start += 30;\n            temp.forEach(w => queue[w + start] = v);\n        }\n        if (i === 2) {\n            start += 60;\n            temp.forEach(w => queue[w + start] = v);\n        }\n    });\n    queue.forEach((v, i) => {\n        if (v === Data.STRING.EMPTY) {\n            return;\n        }\n        if (typeof v === 'number') {\n            exports.ctx.fillStyle = QueueProp.BLOCKS[v].color;\n            exports.ctx.fillRect((Fn.fixToFirstDigit(i) * exports.GRID_SIZE.QUEUE_STEP) + (exports.GRID_SIZE.HORIZON - exports.GRID_SIZE.STEP), (Math.floor(i / Data.NUMBER.ROW) * exports.GRID_SIZE.QUEUE_STEP) + exports.GRID_SIZE.STEP * 1.5, exports.GRID_SIZE.QUEUE_STEP - 2, exports.GRID_SIZE.QUEUE_STEP - 2);\n            exports.ctx.fill();\n        }\n    });\n}\nexports.renderQueue = renderQueue;\n\n\n//# sourceURL=webpack:///./src/render.ts?");
